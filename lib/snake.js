...
Snake.prototype.canMoveDown = function () {
  return !(this.head.isAtBottom() || this.blockBelow())
}
...
Snake.prototype.canMoveUp = function () {
    return !(this.isAtTopEdge() || this.blockOnTop())
}


Snake.prototype.blockToTheLeft  = function () {
    return !!this.board.findBlock(this.head.x - 1, this.head.y);
}
...
Snake.prototype.blockOnTop  = function () {
    return !!this.board.findBlock(this.head.x, this.head.y - 1)
};
